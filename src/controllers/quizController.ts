...
export const createQuiz = async (req: Request, res: Response) => {
  try {
    // body: { title, description, questions: [{ text, allowMultiple?, choices: [{text,isCorrect}] }]}
...
// Soumission: answers = tableau par question
// - si allowMultiple=false: answers[i] = index (number)
// - si allowMultiple=true : answers[i] = number[] (indexes sélectionnés)
